...
export TERRAFORM_PROVIDER_SOURCE := phillbaker/elasticsearch
export TERRAFORM_PROVIDER_REPO := https://github.com/phillbaker/terraform-provider-elasticsearch
export TERRAFORM_PROVIDER_VERSION := 2.0.7
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := terraform-provider-elasticsearch
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-elasticsearch_2.0.7
